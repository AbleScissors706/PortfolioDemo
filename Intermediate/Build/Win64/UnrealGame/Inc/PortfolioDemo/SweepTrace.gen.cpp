...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USweepTrace_Statics::NewProp_TraceDistance = { "TraceDistance", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USweepTrace, TraceDistance), METADATA_PARAMS(Z_Construct_UClass_USweepTrace_Statics::NewProp_TraceDistance_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USweepTrace_Statics::NewProp_TraceDistance_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PortfolioDemo_Source_PortfolioDemo_SweepTrace_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USweepTrace, USweepTrace::StaticClass, TEXT("USweepTrace"), &Z_Registration_Info_UClass_USweepTrace, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USweepTrace), 1898222856U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PortfolioDemo_Source_PortfolioDemo_SweepTrace_h_822984659(TEXT("/Script/PortfolioDemo"),
