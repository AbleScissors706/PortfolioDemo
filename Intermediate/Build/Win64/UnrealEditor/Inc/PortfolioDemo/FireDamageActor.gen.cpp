...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFireDamageActor_Statics::NewProp_DealDamageComponent = { "DealDamageComponent", nullptr, (EPropertyFlags)0x0010000000080009, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFireDamageActor, DealDamageComponent), Z_Construct_UClass_UDealDamageComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AFireDamageActor_Statics::NewProp_DealDamageComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFireDamageActor_Statics::NewProp_DealDamageComponent_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFireDamageActor_Statics::NewProp_ParticleSystemComponent = { "ParticleSystemComponent", nullptr, (EPropertyFlags)0x0010000000080009, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFireDamageActor, ParticleSystemComponent), Z_Construct_UClass_UParticleSystemComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AFireDamageActor_Statics::NewProp_ParticleSystemComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFireDamageActor_Statics::NewProp_ParticleSystemComponent_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_PortfolioDemo_Source_PortfolioDemo_FireDamageActor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PortfolioDemo_Source_PortfolioDemo_FireDamageActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AFireDamageActor, AFireDamageActor::StaticClass, TEXT("AFireDamageActor"), &Z_Registration_Info_UClass_AFireDamageActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AFireDamageActor), 2958058176U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PortfolioDemo_Source_PortfolioDemo_FireDamageActor_h_1714368865(TEXT("/Script/PortfolioDemo"),
		Z_CompiledInDeferFile_FID_PortfolioDemo_Source_PortfolioDemo_FireDamageActor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PortfolioDemo_Source_PortfolioDemo_FireDamageActor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
