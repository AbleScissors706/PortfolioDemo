...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_APortFolioDemoGameModeBase_Statics::NewProp_ObjectiveWidgetClass = { "ObjectiveWidgetClass", nullptr, (EPropertyFlags)0x0014000000010001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APortFolioDemoGameModeBase, ObjectiveWidgetClass), Z_Construct_UClass_UUserWidget_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_APortFolioDemoGameModeBase_Statics::NewProp_ObjectiveWidgetClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APortFolioDemoGameModeBase_Statics::NewProp_ObjectiveWidgetClass_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_PortfolioDemo_Source_PortfolioDemo_PortFolioDemoGameModeBase_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PortfolioDemo_Source_PortfolioDemo_PortFolioDemoGameModeBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_APortFolioDemoGameModeBase, APortFolioDemoGameModeBase::StaticClass, TEXT("APortFolioDemoGameModeBase"), &Z_Registration_Info_UClass_APortFolioDemoGameModeBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APortFolioDemoGameModeBase), 4541050U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PortfolioDemo_Source_PortfolioDemo_PortFolioDemoGameModeBase_h_75806587(TEXT("/Script/PortfolioDemo"),
		Z_CompiledInDeferFile_FID_PortfolioDemo_Source_PortfolioDemo_PortFolioDemoGameModeBase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PortfolioDemo_Source_PortfolioDemo_PortFolioDemoGameModeBase_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
